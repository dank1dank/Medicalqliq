...
- (NSString *)applicationSupportDirectory
{
	...
	if (!result)
	{
		DDLogSupport(@"Unable to find or create application support directory:\n%@", error);
	}
	return result;
}

- (NSString *)applicationSupportDirectoryWithSubDir: (NSString *)appendComponent
{
	NSString *executableName = [NSString stringWithFormat: @"%@/%@",
							    [[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleExecutable"],
								appendComponent];
	NSError *error;
	NSString *result =
