...
- (void)setDefaultStyles
{
    ...
    self.selectedColor = [UIColor colorWithWhite:0.300 alpha:0.600];
...
- (void)prepareApperance
{
    ...
    self.mainLabel.textColor = self.mainLabel.textColor;
    self.mainLabel.highlightedTextColor = self.hightlightedTextColor;
    self.subLabel.textColor = self.subLabel.textColor;
...
//    self.mainLabel.frame = CGRectMake(0, self.frame.size.height / 5, self.frame.size.width, self.frame.size.height/ 2.5);
    self.mainLabel.frame = CGRectMake(0, self.frame.size.height / 5, self.frame.size.width, self.frame.size.height/ 3.0);
    [self addSubview:self.mainLabel];
    
    if(self.tag == 0)
	{
		CGPoint center = self.mainLabel.center;
		center.y = self.bounds.size.height / 2 - 5;
		self.mainLabel.center = center;
	}
    
    self.subLabel.frame = CGRectMake(0, self.mainLabel.frame.origin.y + self.mainLabel.frame.size.height, self.frame.size.width, 10);
...
CGFloat const JCPadButtonHeight = 50.0;
CGFloat const JCPadButtonWidth = 45.0;