...
NSString * NSStringFromUIDeviceFamily(UIDeviceFamily state) {
    switch (state) {
...
//#endif
    // The mapping https://www.theiphonewiki.com/wiki/Models
    // The ever mysterious iFPGA
    if ([platform isEqualToString:@"iFPGA"])        return UIDeviceIFPGA;

    // iPhone [UIDevice currentDevice]
    ...
    if ([platform isEqualToString:@"iPhone9,2"])    return UIDevice7iPhone;
    if ([platform isEqualToString:@"iPhone9,1"])    return UIDevice7iPhone;
...
//#endif
    switch ([self platformType])
    {
        ...
        case UIDeviceUnknowniPhone: return platform; //IPHONE_UNKNOWN_NAMESTRING;
        
        case UIDevice1GiPod: return IPOD_1G_NAMESTRING;
        case UIDevice2GiPod: return IPOD_2G_NAMESTRING;
        case UIDevice3GiPod: return IPOD_3G_NAMESTRING;
        case UIDevice4GiPod: return IPOD_4G_NAMESTRING;
        case UIDeviceUnknowniPod: return platform; //IPOD_UNKNOWN_NAMESTRING;
            
        case UIDevice1GiPad : return IPAD_1G_NAMESTRING;
        case UIDevice2GiPad : return IPAD_2G_NAMESTRING;
        case UIDevice3GiPad : return IPAD_3G_NAMESTRING;
        case UIDevice4GiPad : return IPAD_4G_NAMESTRING;
        case UIDeviceUnknowniPad : return platform; //IPAD_UNKNOWN_NAMESTRING;
            
        case UIDeviceAppleTV2 : return APPLETV_2G_NAMESTRING;
        case UIDeviceAppleTV3 : return APPLETV_3G_NAMESTRING;
        case UIDeviceAppleTV4 : return APPLETV_4G_NAMESTRING;
        case UIDeviceUnknownAppleTV: return platform; //APPLETV_UNKNOWN_NAMESTRING;
        ...
        default: return platform;//IOS_FAMILY_UNKNOWN_DEVICE;
    }
}

- (BOOL) isIphoneXSimulator {
    
    BOOL isSimulatorX = NO;
