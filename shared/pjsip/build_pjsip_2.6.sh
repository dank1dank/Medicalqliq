...
export PJPROJECT_DIR=${PROJECTS_DIR}/pjproject-2.6
...
echo "#define PJSIP_TCP_TRANSPORT_DONT_CREATE_LISTENER 1" >> ${PJCONFIG_FILE}
echo "#define PJSIP_TLS_TRANSPORT_DONT_CREATE_LISTENER 1" >> ${PJCONFIG_FILE}
...
export PJSIPLIBS="libg7221codec libgsmcodec libilbccodec libpj libpjlib-util libpjmedia libpjmedia-audiodev libpjmedia-codec libpjmedia-videodev libpjnath libpjsip libpjsip-simple libpjsip-ua libpjsua libpjsua2 libresample libspeex libsrtp libwebrtc"
